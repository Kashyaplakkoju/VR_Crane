...
namespace GogoGaga.OptimizedRopesAndCables
{
    ...
    public class RopeEditor : Editor
    {
        ...
        private SerializedProperty Midcurve;
        ...
        private void OnEnable()
        {
            ...
            Midcurve = serializedObject.FindProperty(nameof(Rope.Midcurve));
        }
        ...
        private void RopeCurve()
        {
            ...
            EditorGUILayout.PropertyField(Midcurve, new GUIContent("Midpoint Curve", "Adjust the middle control point Bend for the Rational Bezier curve"));
